...
**** TODO Copy =test_all_command_groups_are_registered= to =registry-test=
**** TODO Copy =test_all_commands_are_registered= to =registry-test=
**** TODO Implement =mycmd:registry.register_command_group=
**** TODO Implement =mycmd:registry.register_command=
**** TODO Implement =mycmd:registry.register_item=
**** TODO Further break down tasks
**** TODO Add documentation comments for the registry
**** TODO Load =mycmd-command-group-lib= in =mycmd-registry-lib=
**** TODO Load =mycmd-command-lib= in =mycmd-registry-lib=
**** TODO Load =mycmd-registry-lib= in =mycmd-lib=
**** TODO Call =mycmd:registry.register_mycmd_version_and_description= in =mycmd-lib=
**** TODO Add test for =mycmd-registry-lib= loading
